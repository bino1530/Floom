...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="../asset/image/index/logo.png" type="image/x-icon" />
    <title>Admin Floom</title>
    <link
    rel="stylesheet"
  ...
  <body>
    ...
    <aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="../index.php">
          <img src="../asset/image/index/floom.png" style="width: 60%;" alt="logo" />
        </a>
      </div>
                ...
                <div class="profile-box ml-15">
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                    ...
                    <div class="profile-info">
                      <div class="info">
                        <div class="image">
                          <img src="../asset/image/index/smile.png" alt="" />
                        </div>
                        <div>
                          <h6 class="fw-500">
                            <?php
                                 if (isset($_SESSION["username"])) {
                                    echo "<a href='page/profile.php' class='username'>". $_SESSION["username"]  .  "</a>";
                                 }
                            ?>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    ...
                    <li>
                       ...
                       if (!isset($_SESSION['role'])) {
                        ...
                        echo "<a href='../includes/logout.inc.php'> <i class='lni lni-exit'></i> Đăng xuất </a>";
                      }
                      ?>
